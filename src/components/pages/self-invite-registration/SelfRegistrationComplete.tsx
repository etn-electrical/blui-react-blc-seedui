...
import {
    OrgTxtTitleStyles,
    DialogExtButtonStyles,
    RegCompleteContainerStyles,
    IconContainerStyles,
    OrgTxtStyles,
    DialogButtonStyles,
} from './SelfRegistrationStyle';
import { RegContainerStyles } from '../../../styles/RegistrationStyle';
import { SelfInviteSuccessProps } from '../../../types/selfinvite-types';

export type SelfRegistrationCompleteProps = {
    responseData: SelfInviteSuccessProps;
};
    ...
    return (
        <Box sx={RegContainerStyles(theme)}>
            <Box sx={RegCompleteContainerStyles(theme)}>
                ...
                <Typography sx={OrgTxtTitleStyles(theme)} variant="h6" color="inherit">
                    Welcome {name}!
                </Typography>
                ...
                <Typography sx={OrgTxtStyles(theme)} variant="subtitle2" color={'textSecondary'}>
                    Your Organization {siteName} has also been successfully created and you are now the{' '}
            ...
            <Box>
                ...
                <Button variant="outlined" color="primary" disabled={true} sx={DialogExtButtonStyles()}>
                    {' '}
                    Invite Others{' '}
                </Button>
            </Box>
