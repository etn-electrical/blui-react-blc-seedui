...
describe('Login Api', () => {
    ...
    it('validate Login Api', async () => {
        const res = await loginUser({userName: 'xyz@xyz.com', password: 'Xyz@123', adopterId: '2451fe0b-fcef-4293-aaa1-8a8706ac4506', applicationId: '0oa6c6ymssh6xpgS81d7'} as any)
        expect(res).toMatchObject({"status": 400});
    });
