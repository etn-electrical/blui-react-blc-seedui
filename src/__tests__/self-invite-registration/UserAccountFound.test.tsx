...
describe('Self Registrationn User Account Found', () => {
    ...
    it('to test Accoun Found Component Load', () => {
        ...
        expect(screen.getByText("We found an Eaton account associated with this email address. This means you have already registered this email address for another Eaton application.")).toBeInTheDocument()
    });
});
